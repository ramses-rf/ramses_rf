...
pkt2 = Packet(
    _NOW + td(seconds=10), "...  I --- 32:166025 --:------ 32:166025 1298 003 001230"
)
...
async def test_add_msg() -> None:
    ...
    ret = msg_db.add(msg1)  # replaced message
    ...
    ret = msg_db.add(msg2)  # replaced message
    ...
    ret = msg_db.add(msg3)  # replaced message
...
async def test_qry_msg() -> None:
    ...
    assert not msg_db.contains(plk="co2_level"), "payload keys skipped if value is None"

    with contextlib.suppress(ValueError):
        msg_db.qry_field("RANDOM from messages", (_SRC1, _SRC1))
